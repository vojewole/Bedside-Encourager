...
<body>
	<div style="text-align:center; display:flex; justify-content:space-between; padding-left:300px; padding-right:300px;">
		<h1 style="color:royalblue; text-shadow: 2px 2px black;"><strong>Add a Patient</strong></h1>
	...
	<div style="text-align:left; margin-left:300px;">
		<form:form action="/patients/add" method="post" modelAttribute="patient">
		    ...
		    <div style="padding-left:350px; padding-top:20px;">
		    	<input type="submit" value="Add Patient" class="btn btn-dark row form-inline "/>
		    </div>
		</form:form>    
	</div>
</body>
